...
in_fasta=${1:-input.fasta}
ou_fasta=${2:-output.fasta}

# where the RF model is stored relative to the current working directory
rf_model="./bin/detectability/rfFit.rda"

R --vanilla --nosave <<END
